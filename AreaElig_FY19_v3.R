...
USDA_SHP<-USDA_SHP[,c(3,7,11,12,18,19,20,21,22,23,24)]
...
#set cacluation thresholds
for (i in seq(1,56,1)){
  if (i %in% c(03,07,14,43,52)){
    print(paste("Skip non-State", i))
  } else{
    print(paste("Finding Areas to test:", i))
    USDAData[[i]]$Threshold<-USDAData[[i]]$Pct18BG>=40 | USDAData[[i]]$Pct12BG >=40
  }
}
...
USDA_calc<- function(StateFIPS){ #function calc combos for under 18
  ...
  for(i in seq(1,length(USDAData[[StateFIPS]]$GEOID),1)){ #run through all group blocks
    if (USDAData[[StateFIPS]]$ELIGFY19[i]=="No" & USDAData[[StateFIPS]]$Threshold[i] =="TRUE"){
      ...
      if (length(Neighbors[[StateFIPS]][[i]]) >1){ #if the # of neighboring BGs is more than 1
        ...
        for (n in seq(1,length(comb[,1]),1)){
          ...
          dfcomb2<-data.frame(
            ...
            Perc18=USDAData[[StateFIPS]]$Pct18BG[i],
            ...
            Perc12=USDAData[[StateFIPS]]$Pct12BG[i],
            ...
            B1_Per18=USDAData[[StateFIPS]]$Pct18BG[comb[n,1]],
            ...
            B1_Per12=USDAData[[StateFIPS]]$Pct12BG[comb[n,1]],
            ...
            B2_Perc18=USDAData[[StateFIPS]]$Pct18BG[comb[n,2]],
            ...
            B2_Perc12=USDAData[[StateFIPS]]$Pct12BG[comb[n,2]])
...
#keep only one result above 50% _also filter to 40% threshold
Over50<-list()
for (r in seq(1,56,1)){
  if (r %in% c(03,07,14,43,52)){
    print(paste("Skip non-State", r))
    ...
    Over50[[r]]<-subset.data.frame(Over50[[r]], (Over50[[r]]$Perc18>=40 & Over50[[r]]$B1_Per18 >=40 & Over50[[r]]$B2_Perc18>=40) | (Over50[[r]]$Perc12>=40 & Over50[[r]]$B1_Per12 >=40 & Over50[[r]]$B2_Perc12>=40))
...
for (i in seq(1,56,1)){ 
  if (i %in% c(3,7,14,43,52)){
    ...
    print(i)
    Over50strip[[i]]<-Over50[[i]][,c(1,8:27)]
  }
}
...
for (i in seq(1,56,1)){ 
  if (i %in% c(3,7,14,43,52)){
    ...
    print(i)
    USDADatastrip[[i]]<-USDAData[[i]][,c(2,5:11)]
    colnames(USDADatastrip[[i]])<-c("GEOID","ELIGFY19","Tot18","ID18",'Perc18', "Tot12","ID12",'Perc12')
  }
}
  ...
  if (r %in% c(03,07,14,43,52)){
    ...
    BGLeaflets[[r]]<- BGLeaflets[[r]] %>% addPolygons(data=BGSubsets[[r]][[1]],
                                                      ...
                                                      popup = paste('<b>FY19Elig</b>: Eligable<br>',
                                                                    ...
                                                                    '<b>Under 18 Percent:</b>', BGSubsets[[r]][[1]]$Perc18, '<br>',
                                                                    '<b>Identified Under 12:</b>', BGSubsets[[r]][[1]]$ID12, '<br>',
                                                                    '<b>Total Under 12:</b>', BGSubsets[[r]][[1]]$Tot12, '<br>',
                                                                    '<b>Under 12 Percent:</b>', BGSubsets[[r]][[1]]$Perc12, '<br>'))
    BGLeaflets[[r]]<- BGLeaflets[[r]] %>% addPolygons(data=BGSubsets[[r]][[2]],
                                                      ...
                                                      popup = paste('<b>FY19Elig</b>: Not Eligable<br>',
                                                                    ...
                                                                    '<b>Under 18 Percent:</b>', BGSubsets[[r]][[2]]$Perc18, '<br>',
                                                                    '<b>Identified Under 12:</b>', BGSubsets[[r]][[2]]$ID12, '<br>',
                                                                    '<b>Total Under 12:</b>', BGSubsets[[r]][[2]]$Tot12, '<br>',
                                                                    '<b>Under 12 Percent:</b>', BGSubsets[[r]][[2]]$Perc12, '<br>'))
    BGLeaflets[[r]]<- BGLeaflets[[r]] %>% addPolygons(data=BGSubsets[[r]][[3]],
                                                      ...
                                                      popup = paste('<b>FY19Elig</b>: Calculation Eligable<br>',
                                                                    ...
                                                                    '<b>Under 18 Percent:</b>', BGSubsets[[r]][[3]]$Perc18, '<br>',
                                                                    '<b>Identified Under 12:</b>', BGSubsets[[r]][[3]]$ID12, '<br>',
                                                                    '<b>Total Under 12:</b>', BGSubsets[[r]][[3]]$Tot12, '<br>',
                                                                    '<b>Under 12 Percent:</b>', BGSubsets[[r]][[3]]$Perc12, '<br><hr>',
                                                                    ...
                                                                    '<table border="1">
                                                                      ...
                                                                      <td align="center">',BGSubsets[[r]][[3]]$B1_Per18,'</td>
                                                                      <td align="center">',BGSubsets[[r]][[3]]$B1_ID12,'</td>
                                                                      <td align="center">',BGSubsets[[r]][[3]]$B1_Tot12,'</td>
                                                                      <td align="center">',BGSubsets[[r]][[3]]$B1_Per12,'</td>
                                                                      </tr>
                                                                      <tr>
                                                                      ...
                                                                      <td align="center">', BGSubsets[[r]][[3]]$B2_Perc18, '</td>
                                                                      <td align="center">', BGSubsets[[r]][[3]]$B2_ID12, '</td>
                                                                      <td align="center">', BGSubsets[[r]][[3]]$B2_Tot12, '</td>
                                                                      <td align="center">', BGSubsets[[r]][[3]]$B2_Perc12, '</td>
                                                                      </tr>
                                                                      <tr>
